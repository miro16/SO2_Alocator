...
# Znacznik czasowy: 2023-11-30 19:45:40.765244
#

OUTDIR		:= build-dir

CC          := gcc
CC_FLAGS    := -Wall -pedantic -ggdb3 -Wextra -Wno-error=implicit-fallthrough -xc -Werror -Wno-error=parentheses -Wno-error=unused-parameter -Wno-parentheses -D_GNU_SOURCE -fdiagnostics-color -std=c11 -Werror=vla -DINSIDE_DANTE -D_ANSI_OUTPUT -fmax-errors=5 
...
LD          := gcc
LD_FLAGS    := -Wl,-wrap,main -ggdb3 -Wl,-Map=main.map -Wl,-cref 
LD_LIBS     := -lpthread -lm 
